  ...
  return (
    <div
      className={`navbar fixed top-0 left-1/2 mt-4 transform -translate-x-1/2 rounded-full shadow-lg w-[90%] lg:w-[80%] z-50 flex justify-between items-center px-4 transition-all duration-300 ${
        isScrolled
          ? "py-1 bg-primary/90 mt-1 text-white shadow-md"
    ...
    >
      ...
      <div
        className={`lg:flex lg:items-center lg:space-x-6 ${
          isMenuOpen
            ? "flex flex-col items-center bg-primary w-full absolute top-full left-0 z-40 rounded-b-lg p-4"
            : "hidden"
      ...
      <div className=" lg:flex items-center ml-4">
        <div>
          {!user ? (
            <button
              className={`btn rounded-full bg-[#ffffff] hover:bg-primary-light hover:text-white hover:border-white text-black px-6 mr-4 transition-colors duration-300 ${
